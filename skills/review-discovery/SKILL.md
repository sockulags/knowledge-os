...
Never silently promote, overwrite, supersede, or merge an existing record. Promotion is new-draft creation, not verification; merge-to-existing is postponed.
